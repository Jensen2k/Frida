...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[[AppDelegate items] objectAtIndex:indexPath.row] objectForKey:@"name"];
  cell.detailTextLabel.text = [[[AppDelegate items] objectAtIndex:indexPath.row] objectForKey:@"group"];
